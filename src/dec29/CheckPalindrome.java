...
/**
* 
* This class scan a 5 digit integer number from the user. The scan number is then reversed
* and later checked with original number to find whether the given number is a palindrome.
* 
		...
		do {
			...
			do{
				...
				try{	
					...
					System.out.println("Error : Please enter interger number \n");
					scan.next();
					wrongInput = true;
				}
			}while(wrongInput);
