 ...
 * 
 * 
 * 1. Write a program that displays the temperatures from 0 degrees Celsius to
 ...
 * temperature from 0°C to 100°C. Also with its conversion into degree
 * Fahrenheit.
 * 
...
public class TempConverter {
	...
	public static void main(String[] args) {
		...
		for (int cDegree = 0; cDegree < 100; cDegree++) {
			fDegree = ((float) cDegree * 9 / 5 + 32);
			count++;
			System.out.println(count + "\t" + cDegree + Degree + "C equals to "
					+ fDegree + Degree + "F");
		}
	}
}
